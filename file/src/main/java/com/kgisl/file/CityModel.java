...
public class CityModel {
    ...
    public String toString() {
        return "Model [city=" + city + ", city_ascii=" + city_ascii + ", lat=" + lat + ", lng=" + lng + ", country="
                + country + ", iso2=" + iso2 + ", iso3=" + iso3 + ", admin_name=" + admin_name + ", capital=" + capital
                + ", population=" + population + ", id=" + id + "]";
    }
    public CityModel(String city, String city_ascii, String lat, String lng, String country, String iso2, String iso3,
